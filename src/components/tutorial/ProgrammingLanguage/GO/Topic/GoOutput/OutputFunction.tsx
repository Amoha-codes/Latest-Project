...
const GoOutputFunctions: React.FC = () => (
  <div className="mt-20">
    ...
    <h2 className="text-2xl font-bold text-gray-800 mt-6">The Print() Function</h2>
...
func main() {
  ...
  fmt.Print(j)
    ...
    <pre className="bg-gray-100 p-4 rounded-lg text-sm">HelloWorld</pre>

    <h3 className="text-xl font-semibold text-gray-800 mt-6">Example (Using New Lines)</h3>
    <p className="mt-2 text-gray-700">If we want to print the arguments in new lines, we need to use <code>\n</code>.</p>
    <pre className="bg-gray-100 p-4 rounded-lg text-sm mt-2">
{`package main
import ("fmt")
...
func main() {
  ...
  fmt.Print(j, "\n")
    ...
    <p className="mt-2 text-gray-700">Result:</p>
    <pre className="bg-gray-100 p-4 rounded-lg text-sm">Hello{"\n"}World</pre>
    <p className="mt-2 text-gray-700"><strong>Tip:</strong> \n creates new lines.</p>

    <h3 className="text-xl font-semibold text-gray-800 mt-6">Example (Single Print)</h3>
    <p className="mt-2 text-gray-700">
...
func main() {
  ...
  fmt.Print(i, "\n",j)
    ...
    <h3 className="text-xl font-semibold text-gray-800 mt-6">Example (Add Space Between Strings)</h3>
    <p className="mt-2 text-gray-700">
...
func main() {
  ...
  fmt.Print(i, " ", j)
    ...
    <p className="mt-2 text-gray-700">Result:</p>
    <pre className="bg-gray-100 p-4 rounded-lg text-sm">Hello World</pre>

    <h3 className="text-xl font-semibold text-gray-800 mt-6">Example (Numbers)</h3>
    <p className="mt-2 text-gray-700">
...
func main() {
  ...
  fmt.Print(i,j)
    ...
    <p className="mt-2 text-gray-700">Result:</p>
    <pre className="bg-gray-100 p-4 rounded-lg text-sm">10 20</pre>

    <h2 className="text-2xl font-bold text-gray-800 mt-8">The Println() Function</h2>
    <p className="mt-2 text-gray-700">
...
func main() {
  ...
  fmt.Println(i,j)
    ...
    <h2 className="text-2xl font-bold text-gray-800 mt-8">The Printf() Function</h2>
    <p className="mt-2 text-gray-700">

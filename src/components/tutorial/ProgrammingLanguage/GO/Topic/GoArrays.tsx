...
const GoArrays: React.FC = () => (
  <div className="mt-20">
    ...
    <h2 className="text-2xl font-bold text-gray-800 mt-6">Declare an Array</h2>
    <p className="text-lg text-gray-700 mt-4">
      In Go, there are two ways to declare an array:
    </p>

    <p className="text-lg text-gray-700 mt-4">1. With the var keyword:</p>
    <pre className="bg-gray-100 p-4 rounded-lg mt-2 overflow-x-auto">
{`var array_name = [length]datatype{values} // here length is defined
var array_name = [...]datatype{values} // here length is inferred`}
    </pre>

    <p className="text-lg text-gray-700 mt-4">2. With the := sign:</p>
    <pre className="bg-gray-100 p-4 rounded-lg mt-2 overflow-x-auto">
...
array_name := [...]datatype{values} // here length is inferred`}
    ...
    <h2 className="text-2xl font-bold text-gray-800 mt-6">Array Examples</h2>
...
6`}
    ...
    <h2 className="text-2xl font-bold text-gray-800 mt-6">Exercise</h2>
    <p className="text-lg text-gray-700 mt-4">

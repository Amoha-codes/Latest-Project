...
const CsharpDisplayVariables: React.FC = () => (
  <div className="mt-20 px-6 md:px-20 lg:px-32"> {/* 👈 added padding for full-screen layout */}
    ...
    <div className="bg-gray-900 text-green-400 font-mono p-6 rounded-xl shadow-lg mt-3 w-full">
...
Console.WriteLine(x + y); // Print the value of x + y`}
    ...
    <h3 className="text-xl font-semibold text-gray-800 mt-8">Output:</h3>
    <div className="bg-gray-100 border-l-4 border-gray-400 p-4 rounded-lg text-gray-800 font-mono mt-2">
      11
    </div>

    <h2 className="text-2xl font-bold text-[#6334B9] mt-8">Explanation</h2>

...
const CsharpVariables: React.FC = () => (
  <div className="mt-20"> {/* 👈 pushes content below navbar */}
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Variable Types</h2>
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Declaring (Creating) Variables</h2>
...
{`type variableName = value;`}
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Example 1: String Variable</h2>
    <p className="text-gray-700 leading-relaxed mt-2">
...
Console.WriteLine(name);`}
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Example 2: Integer Variable</h2>
    <p className="text-gray-700 leading-relaxed mt-2">
...
Console.WriteLine(myNum);`}
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Example 3: Declare First, Assign Later</h2>
    <p className="text-gray-700 leading-relaxed mt-2">
...
Console.WriteLine(myNum);`}
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Example 4: Overwriting Variables</h2>
    <p className="text-gray-700 leading-relaxed mt-2">
...
Console.WriteLine(myNum);`}
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Other Variable Types</h2>
    <p className="text-gray-700 leading-relaxed mt-2">

...
const CsharpWhileLoop: React.FC = () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">Loops</h2>
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">C# While Loop</h2>
...
while (i < 5)
{
  ...
  i++;
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-8">The Do/While Loop</h2>
    <p className="text-gray-700 leading-relaxed mt-3">

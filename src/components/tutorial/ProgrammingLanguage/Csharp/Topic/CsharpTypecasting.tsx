...
const CsharpTypecasting: React.FC = () => (
  <div className="mt-20">
    ...
    <div className="bg-gray-100 rounded-lg p-4 mt-4">
      <p className="text-gray-800 font-mono">Implicit Casting: char → int → long → float → double</p>
      <p className="text-gray-800 font-mono mt-1">Explicit Casting: double → float → long → int → char</p>
    </div>

    <h2 className="text-2xl font-bold text-[#6334B9] mt-8">Implicit Casting</h2>
...
Console.WriteLine(myInt);     // Outputs 9`}
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-8">Type Conversion Methods</h2>
    <p className="text-gray-700 leading-relaxed mt-3">

...
const intro: React.FC = () => (
  <div className="mt-20">
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">What is C#?</h2>
    ...
    <h2 className="text-2xl font-bold text-[#634B9] mt-6">C# is used for:</h2>
    ...
    <h2 className="text-2xl font-bold text-[#634B9] mt-6">Why Use C#?</h2>

...
const CsharpComments: React.FC = () => (
  <div className="mt-20"> {/* 👈 pushes content below navbar */}
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Single-line Comments</h2>
...
Console.WriteLine("Hello World!");`}
    ...
    <h2 className="text-2xl font-bold text-blue-600 mt-6">Single or Multi-line Comments?</h2>
    <p className="text-gray-700 leading-relaxed mt-2">

...
const CsharpConstants: React.FC = () => (
  <div className="mt-20"> {/* 👈 pushes content below navbar */}
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">Declaring a Constant</h2>
...
myNum = 20; //  Error: Cannot modify a constant value`}
    ...
    <h3 className="text-xl font-semibold text-gray-800 mt-4">Explanation:</h3>
...
Console.WriteLine(DaysInWeek);`}
    ...
    <h3 className="text-xl font-semibold text-gray-800 mt-4">Output:</h3>

...
string myText = "Hello";     // String`}
    ...
    <div className="bg-gray-900 text-green-400 font-mono p-4 rounded-lg shadow-md mt-2">
...
Console.WriteLine(myNum);`}</pre>
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-8">Floating Point Types</h2>
...
Console.WriteLine(myNum);`}</pre>
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-8">Scientific Numbers</h2>
    <div className="bg-gray-900 text-green-400 font-mono p-4 rounded-lg shadow-md mt-3">
      <pre>{`float f1 = 35e3F;
double d1 = 12E4D;

...
if ("Volvo" in cars) {
  ...
  println("It does not exist.")
    ...
    <p className="text-lg text-gray-700 mt-2">Example: Stop the loop when <code>nums</code> is equal to 10:</p>
    <pre className="bg-gray-100 p-4 rounded-lg mt-2 text-sm">
      <code>{`for (nums in 5..15) {
  if (nums == 10) {
    break
  ...
  println(nums)
    ...
    <p className="text-lg text-gray-700 mt-2">Example: Skip the value of 10 in the loop:</p>
    <pre className="bg-gray-100 p-4 rounded-lg mt-2 text-sm">
      <code>{`for (nums in 5..15) {
  if (nums == 10) {
    continue

...
const SwiftFunctions: React.FC = () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">Defining and Calling Functions</h2>
...
print(greet(name: "Swift"))`}</pre>
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">Parameters and Return Values</h2>
    <p className="text-gray-700 leading-relaxed mt-3">

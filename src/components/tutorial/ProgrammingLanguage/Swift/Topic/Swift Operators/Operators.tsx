...
const SwiftOperators: React.FC = () => (
  <>
    ...
    {/* Operator Families */}
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">Operator Families at a Glance</h2>
...
print(t && !f)`}</pre>
    ...
    {/* Unary and Ternary */}
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">Unary and Ternary Operators</h2>
    <p className="text-gray-700 leading-relaxed mt-3">

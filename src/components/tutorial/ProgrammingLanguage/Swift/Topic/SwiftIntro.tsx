...
const SwiftIntroduction: React.FC = () => (
  <>
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">What is Swift?</h2>
...
{`print("Hello, Swift!")`}
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">Why Use Swift?</h2>
    ...
    <h2 className="text-2xl font-bold text-[#6334B9] mt-6">Swift History</h2>

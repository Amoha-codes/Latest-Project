...
const SwiftSidebar: React.FC<SidebarProps> = ({ selected, onSelect }) => {
  ...
  return (
    <aside className="w-72 bg-gray-50 text-gray-900 border-r border-gray-200 shadow-sm min-h-screen overflow-y-auto mt-20">
      {/* Header */}
            ...
            <button
              ...
              className={`flex items-center justify-between w-full text-left font-semibold py-2 rounded-md px-3 transition-all ${
                selected === item.component
                  ...
                  : "text-gray-800 hover:bg-purple-100 hover:text-[#6334B9]"
              }`}
            >
                    ...
                    <button
                      ...
                      className={`block w-full text-left px-2 py-1 rounded-md text-sm ${
                        selected === sub.component
                          ? "bg-blue-200 text-[#6334B9] font-medium"
                          : "text-gray-600 hover:bg-blue-50 hover:text-[#6334B9]"
                      }`}
                    >
                      {sub.title}
                    </button>
